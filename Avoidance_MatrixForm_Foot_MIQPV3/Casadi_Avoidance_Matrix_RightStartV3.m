function [] = Casadi_Avoidance_Matrix_RightStartV3(step_index)
import casadi.*
% System Parameters
...
swf_s = MX.sym('swf_s', round(Tstep / dt) + 2);        % swinf foot slack variable
...
key_y_err = key_footy_pos - key_y_pos - diy * (-1).^(2:Npred+1)';
...
for n = step_index + 1 : round(Tstep / dt) + 1
    ...
    elseif n == round(Tstep / dt) + 1
        ...
        eq_con = [eq_con;sum(swf_bi(1:8)) - 1;sum(swf_bi(9:16)) - 1];
        cp = [cur_p(1:2);sec_f];
        op = swf_obs_pos(1:2);
        ...
        for i = 0:1
            ...
            % Block one
            ieq_con = [ieq_con;...
                       cx - ox + swf_obs_r1 - M*(1-swf_bi(1 + 8*i)) - swf_s(n+i);...
                       cx - ox + swf_obs_r1 - M*(1-swf_bi(1 + 8*i));...
                      -cy + oy + swf_obs_r1 - M*(1-swf_bi(1 + 8*i)) - swf_s(n+i);...
                      -cy + oy + swf_obs_r1 - M*(1-swf_bi(1 + 8*i))];
    
            % Block two
            ieq_con = [ieq_con;...
                       cx - ox + swf_obs_r1 - M*(1-swf_bi(2 + 8*i));...
                       cx - ox + swf_obs_r1 - M*(1-swf_bi(2 + 8*i)) - swf_s(n+i);...
                      -cy + oy - swf_obs_r1 - M*(1-swf_bi(2 + 8*i));...
                       cy - oy - swf_obs_r1 - M*(1-swf_bi(2 + 8*i))];
    
            % Block three
            ieq_con = [ieq_con;...
                       cx - ox + swf_obs_r1 - M*(1-swf_bi(3 + 8*i)) - swf_s(n+i);...
                       cx - ox + swf_obs_r1 - M*(1-swf_bi(3 + 8*i));...
                       cy - oy + swf_obs_r1 - M*(1-swf_bi(3 + 8*i)) - swf_s(n+i);...
                       cy - oy + swf_obs_r1 - M*(1-swf_bi(3 + 8*i))];
    
            % Block four
            ieq_con = [ieq_con;...
                      -cx + ox - swf_obs_r1 - M*(1-swf_bi(4 + 8*i));...
                       cx - ox - swf_obs_r1 - M*(1-swf_bi(4 + 8*i));...
                       cy - oy + swf_obs_r1 - M*(1-swf_bi(4 + 8*i));...
                       cy - oy + swf_obs_r1 - M*(1-swf_bi(4 + 8*i)) - swf_s(n+i)];
    
            % Block five
            ieq_con = [ieq_con;...
                      -cx + ox + swf_obs_r1 - M*(1-swf_bi(5 + 8*i)) - swf_s(n+i);...
                      -cx + ox + swf_obs_r1 - M*(1-swf_bi(5 + 8*i));...
                       cy - oy + swf_obs_r1 - M*(1-swf_bi(5 + 8*i)) - swf_s(n+i);...
                       cy - oy + swf_obs_r1 - M*(1-swf_bi(5 + 8*i))];
    
            % Block six
            ieq_con = [ieq_con;...
                      -cx + ox + swf_obs_r1 - M*(1-swf_bi(6 + 8*i));...
                      -cx + ox + swf_obs_r1 - M*(1-swf_bi(6 + 8*i)) - swf_s(n+i);...
                      -cy + oy - swf_obs_r1 - M*(1-swf_bi(6 + 8*i));...
                       cy - oy - swf_obs_r1 - M*(1-swf_bi(6 + 8*i))];
    
            % Block seven
            ieq_con = [ieq_con;...
                      -cx + ox + swf_obs_r1 - M*(1-swf_bi(7 + 8*i)) - swf_s(n+i);...
                      -cx + ox + swf_obs_r1 - M*(1-swf_bi(7 + 8*i));...
                      -cy + oy + swf_obs_r1 - M*(1-swf_bi(7 + 8*i)) - swf_s(n+i);...
                      -cy + oy + swf_obs_r1 - M*(1-swf_bi(7 + 8*i))];
    
            % Block eight
            ieq_con = [ieq_con;...
                      -cx + ox - swf_obs_r1 - M*(1-swf_bi(8 + 8*i));...
                       cx - ox - swf_obs_r1 - M*(1-swf_bi(8 + 8*i));...
                      -cy + oy + swf_obs_r1 - M*(1-swf_bi(8 + 8*i));...
                      -cy + oy + swf_obs_r1 - M*(1-swf_bi(8 + 8*i)) - swf_s(n+i)];
...
fff = Function(char('RightStart_Step' + string(step_index) + 'V3'),{Input,Variable},{Aeq,beq,Aiq,biq,H,f});
...
cg = CodeGenerator(char('RightStart_Step' + string(step_index) + 'V3'),cg_options);
cg.add(fff);
tic
cg.generate() 
toc
