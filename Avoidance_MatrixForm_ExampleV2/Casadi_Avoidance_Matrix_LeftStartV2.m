function [] = Casadi_Avoidance_Matrix_LeftStartV2(step_index)
import casadi.*
% System Parameters
...
fff = Function(char('LeftStart_Step' + string(step_index) + 'V2'),{Input,Variable},{Aeq,beq,Aiq,biq,H,f});
...
cg = CodeGenerator(char('LeftStart_Step' + string(step_index) + 'V2'),cg_options);
cg.add(fff);
tic
cg.generate() 
toc
