function [] = Casadi_Avoidance_Matrix_RightStartV2(step_index)
import casadi.*
% System Parameters
...
Input = [q_init;x_ref;y_ref;f_length;f_init;f_param;Weights;r;qo_ic;qo_tan;rt;foff];
...
fff = Function(char('RightStart_Step' + string(step_index) + 'V2'),{Input,Variable},{Aeq,beq,Aiq,biq,H,f});
...
cg = CodeGenerator(char('RightStart_Step' + string(step_index) + 'V2'),cg_options);
cg.add(fff);
tic
cg.generate() 
toc
